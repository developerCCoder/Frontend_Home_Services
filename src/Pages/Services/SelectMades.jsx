...
const SelectMades = () => {
  ...
  const pricePerHourPerMaid = 60;

  useEffect(() => {
    if (formData.hours !== null && formData.maid !== null) {
      const calculatedAmount = formData.hours * formData.maid * pricePerHourPerMaid;
      setFormData((prevData) => ({
        ...prevData,
        totalAmount: calculatedAmount, // Update totalAmount in the formData
      }));
    }
